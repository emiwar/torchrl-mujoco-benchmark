...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    test_env = make_env(batch_size=[1], worker_threads=1, device=device)
    test_env.eval()
    ...
    for i, data in enumerate(collector):
        ...
        for j in range(cfg_loss_ppo_epochs):
            ...
            # Use the replay buffer to cache experiences for clarity but clear each time
            ...
            # Empty the replay buffer each time (so it's online learning)
            data_buffer.empty()
